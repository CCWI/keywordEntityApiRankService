...
public class AlchemyKeywordAPI extends APIBasics implements InterfaceAPI {
	...
	public void createPOST(String message) throws UnsupportedEncodingException {
		...
		httppost = new HttpPost(Configuration.alchemyKeywordApiUri);
	...
	public void receiveGET() throws IOException, ParseException {
		JSONArray JSONArray = readResponseJSON(API_IDENTIFIER, EntityUtils.toString(httpEntity, "UTF-8"), "keywords");
